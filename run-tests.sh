...
This script will:
    ...
    Usage:
        ...
        $0 -i <IMAGE> -p <PROFILE> -r <RELEASE> -n <PROPER_NAME>
        
    Example:
    
        $0 -i ea2245b6-fcce-4968-a448-6784b962e558 -p testing-dc -r 16.04 -n "Ubuntu 16.04"
    ...
    Options:
        ...
        -r The release version of the image e.g., 16.04
...
if [[ -z $IMAGE ]] || [[ -z $PROFILE ]] || [[ -z $RELEASE ]] ||[[ -z $PROPER_NAME ]]; then
    usage
    exit 1
fi
